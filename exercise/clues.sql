-- "\connect world" will connect you to the database
-- "\x" will toggle expanded display for easier reading
-- Time to track Carmen! Let’s piece together the clues step by step.
\connect world  
\x              
