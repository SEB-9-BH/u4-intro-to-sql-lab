...
-- Write SQL query here
SELECT name FROM countries WHERE code = (SELECT countrycode FROM countrylanguages WHERE language='Italian' AND isofficial = True AND percentage = 100);
...
SELECT name, region FROM countries WHERE code = 'BRA';
