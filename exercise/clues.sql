...
-- Write SQL query here
SELECT c.name FROM countries c JOIN countrylanguages cl ON c.code = cl.countrycode
...
SELECT name , countrycode FROM cities WHERE name!= 'Serravalle' AND name LIKE 'Serra%';
-- -[ RECORD 1 ]-----------
-- name        | Serra
-- countrycode | BRA
